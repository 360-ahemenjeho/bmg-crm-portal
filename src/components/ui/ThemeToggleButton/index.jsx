  ...
  return (
    <Box
      ...
      sx={{
        ...
        backgroundColor: isDark ? "rgba(139, 92, 246, 0.12)" : "rgba(251, 191, 36, 0.12)",
        "&:hover": {
          backgroundColor: isDark ? "rgba(139, 92, 246, 0.22)" : "rgba(251, 191, 36, 0.22)",
          boxShadow: isDark
        ...
        "&::after": {
          ...
          inset: 0,
          borderRadius: "50%",
          background: isDark ? "rgba(139, 92, 246, 0.25)" : "rgba(251, 191, 36, 0.3)",
          opacity: spinning ? 1 : 0,
          transform: spinning ? "scale(2.2)" : "scale(0)",
          transition: spinning ? "transform 0.5s ease-out, opacity 0.5s ease-out" : "none",
        },
      }}
    >
      <Box
      ...
      >
        {isDark ? (
          <WeatherMoonRegular fontSize={20} style={{ color: "rgb(167, 139, 250)" }} />
        ) : (
          <WeatherSunnyRegular fontSize={20} style={{ color: "rgb(245, 158, 11)" }} />
        )}
      </Box>
    </Box>
  );
